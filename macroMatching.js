{
    ...
    //TODO: NOTATION SUGGESTION (?) Tag trigger words of long phrases to prompt the AI to ask the user 
        ...
        //Parses as an array of strings, if each string is not contained in the query, the algorithm will test to see if the operative words exist, if so, the computer will ask if you meant to say the pre-programmed query
